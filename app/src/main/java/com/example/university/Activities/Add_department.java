...
public class Add_department extends AppCompatActivity{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Dep_text = findViewById(R.id.Dep_text);
                ...
                try {
                    ...
                    for(int i=0;i<jsonArray.length();i++)
                    {
                        try {
                            ...
                            adapter_faculty = new ArrayAdapter<>(Add_department.this,
        ...
        RequestHandler.getInstance(Add_department.this).addToRequestQueue(stringRequest);
        ...
        progressDialog = new ProgressDialog(Add_department.this);
        add.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                if (!selectedFaculty.getName().isEmpty()) {
                    progressDialog.show();
                    StringRequest stringRequest2 = new StringRequest(Request.Method.POST, Constants.URL_Department, new Response.Listener<String>() {
                        @Override
                        public void onResponse(String response) {
                            ...
                            try {
                                ...
                                if (jsonObject.getString("message").equals("Department added successfully")) {
                        ...
                        protected Map<String, String> getParams() throws AuthFailureError {
                            ...
                            stringMap.put("Dep_name", Dep_text.getText().toString());
                            stringMap.put("faculty_id", selectedFaculty.getId()+"");
                            return stringMap;
                        }
                    };
                    RequestHandler.getInstance(Add_department.this).addToRequestQueue(stringRequest2);
                }else
                {
                    DesignerToast.Info(getApplicationContext(), "Enter name of Department First", Gravity.BOTTOM, Toast.LENGTH_SHORT);
                }
            }
        });
