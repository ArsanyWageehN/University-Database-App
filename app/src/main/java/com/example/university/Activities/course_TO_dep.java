...
public class course_TO_dep extends AppCompatActivity {

    Spinner spinner_faculty,spinner_Department,spinner_Courses;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_course_to_dep);
                ...
                try {
                    ...
                    for(int i=0;i<jsonArray.length();i++)
                    {
                        try {
                            ...
                            adapter_faculty = new ArrayAdapter<>(course_TO_dep.this,
        ...
        RequestHandler.getInstance(course_TO_dep.this).addToRequestQueue(stringRequest);
        ...
        spinner_faculty.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                ...
                Departments.clear();
                adapter_Dep = new ArrayAdapter<>(course_TO_dep.this,
                ...
                Courses.clear();
                adapter_crs = new ArrayAdapter<>(course_TO_dep.this,
        ...
        progressDialog = new ProgressDialog(course_TO_dep.this);
        ...
        add.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (!selectedFaculty.getName().isEmpty()&&!selectedDep.getName().isEmpty()&&!selectedCRS.getCrs_name().isEmpty()) {
                        ...
                        public void onClick(DialogInterface dialog, int which) {
                            switch (which) {
                                case DialogInterface.BUTTON_POSITIVE:
                                    progressDialog.show();
                                    StringRequest stringRequest2 = new StringRequest(Request.Method.POST, Constants.URL_Connect_Course, new Response.Listener<String>() {
                                        @Override
                                        public void onResponse(String response) {
                                            ...
                                            try {
                                                ...
                                                if (jsonObject.getString("message").equals("Course added to department successfully")) {
                                                ...
                                                DesignerToast.Warning(getApplicationContext(), "It added already", Gravity.BOTTOM, Toast.LENGTH_SHORT);
                                            }
                                        }
                                    }, new Response.ErrorListener() {
                                        @Override
                                    ...
                                    RequestHandler.getInstance(course_TO_dep.this).addToRequestQueue(stringRequest2);
                    ...
                    AlertDialog.Builder builder = new AlertDialog.Builder(course_TO_dep.this);
